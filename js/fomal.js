...
$.ajax({
  ...
  data: {
    key: 'OHGBZ-WZT6J-4ORFG-XMQJI-KSBDQ-FGFAD',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime1() {
  var grt = new Date("24/10/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime() {
  ...
  var start = new Date("10/24/2024 00:00:00"); // 旅行者1号开始计算的时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='/img/icons_work.png' title='什么时候才能实现财富自由呢'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='/img/icons_sleep.png' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://eimoe.cn/img/webDay.png);
    --darkmode-bg: url(https://eimoe.cn/img/webNight.png);
    --mobileday-bg: url(https://eimoe.cn/img/mobileDay.png);
    --mobilenight-bg: url(https://eimoe.cn/img/mobileNight.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://eimoe.cn/img/Background/ACG/ACG1.png)" class="imgbox" onclick="changeBg('url(https://eimoe.cn/img/Background/ACG/ACG1.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://eimoe.cn/img/Background/ACG/ACG2.png)" class="imgbox" onclick="changeBg('url(https://eimoe.cn/img/Background/ACG/ACG2.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://eimoe.cn/img/Background/ACG/ACG3.png)" class="imgbox" onclick="changeBg('url(https://eimoe.cn/img/Background/ACG/ACG3.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://eimoe.cn/img/Background/ACG/ACG4.png)" class="imgbox" onclick="changeBg('url(https://eimoe.cn/img/Background/ACG/ACG4.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://eimoe.cn/img/Background/ACG/ACG5.png)" class="imgbox" onclick="changeBg('url(https://eimoe.cn/img/Background/ACG/ACG5.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https